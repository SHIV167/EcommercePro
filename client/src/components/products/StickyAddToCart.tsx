...
export default function StickyAddToCart({ product, quantity, setQuantity, onAddToCart }: StickyAddToCartProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-50 flex items-center justify-center pointer-events-none">
      <div className="bg-white shadow-2xl border border-neutral-sand rounded-t-xl flex items-center gap-2 md:gap-4 px-2 md:px-6 py-2 md:py-4 w-full max-w-2xl mx-auto pointer-events-auto animate-slideup">
        <img
          ...
          alt={product.name}
          className="w-10 h-10 md:w-14 md:h-14 rounded object-cover border"
        />
        ...
        <Button
          size="lg"
          className="ml-2 md:ml-4 px-4 md:px-8 bg-primary hover:bg-primary-dark text-white font-bold shadow-md w-full md:w-auto"
